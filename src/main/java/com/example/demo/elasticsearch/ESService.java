...
public class ESService {
    ...
    /**
     * Make a PUT request to elastic search to add a document to an index.
     *
     * @param esRequest
     * @throws IOException
     */
...
//        System.out.println("==== added doc to elastic search:\n" + esRequest);
    }

    /**
     * Make a DELETE request to elastic search to delete a document in an index.
     *
     * @param esRequest
     * @throws IOException
     */
